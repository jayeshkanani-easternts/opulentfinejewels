...
$("#deleteMultiple").click(function(){
	  ...
	  var result = confirm("Are You Sure you want to delete? ");
		...
		{	
			...
			var loc = 'index.php?controller=brochure&action=brochure&subaction=delete&b_id='+finalDelArray;
...
?>
	<script>
	$(document).ready(function() {
		var listURL = "helperfunc/brochureList.php";
		var oTable = $('#brochurelist').dataTable({
			"ajax": listURL ,
			"order": [[ 4, "desc" ]]
		});
...
<?php
	...
	echo '<a href="brochure-report.php">Export To Excel</a><br>';
	echo '<div id="no-more-tables">
	<table class="table table-striped table-bordered dataTable" id="brochurelist" style="width:100%;">
		<thead>
		<tr>
