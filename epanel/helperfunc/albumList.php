...
//				</td>';
				...
				if(strpos($_SESSION['userper'],'d') !== false) {
					$Action.= '| <a href="index.php?controller=gallery&action=album&subaction=delete&a_id='.$res['a_id'].'" title="Delete Records" data-toggle="tooltip" class="btn btn-danger marker" onClick="return confirmSubmit();" ><i class="fa fa-times"></i></a>
					</td>';
				}
